...
?>
 ...
 <div class="form-group">
  ...
  <input type="number" name="ano_lancamento" value="<?php echo $row['ano_lancamento']; ?>" min="1970" max="<?php echo date('Y'); ?>" required>
 </div>

 <div class="form-group">
  <label for="genero">Gênero:</label>
  <input type="text" name="genero" value="<?php echo htmlspecialchars($row['genero']); ?>" required>
 </div>

 <div class="form-group">
  <label for="classificacao">Classificação Indicativa:</label>
  <input type="text" name="classificacao" value="<?php echo htmlspecialchars($row['classificacao']); ?>" required>
 </div>
