...
class JogoController {
    ...
    public function create($nome, $descricao, $preco, $console_id, $ano, $genero, $classificacao) {
    $this->jogo->nome = $nome;
    $this->jogo->descricao = $descricao;
    $this->jogo->preco = $preco;
    $this->jogo->console_id = $console_id;
    $this->jogo->ano_lancamento = $ano;
    $this->jogo->genero = $genero;
    $this->jogo->classificacao = $classificacao;

    return $this->jogo->create();
}
